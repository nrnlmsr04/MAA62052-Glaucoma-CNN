...
## 👥 Group Members (Group ID: [Insert Group ID])
...
- `Copy_of_PROJECT_2_MESIN.ipynb`: The main Jupyter Notebook containing the complete end-to-end workflow (EDA, preprocessing, model training, and clinical evaluation).
